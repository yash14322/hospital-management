...
void PAT_LIST()
{
    ...
    strcpy(pat_old[2].doctor,"SHIVANI");
    ...
    strcpy(pat_old[3].doctor,"HARIHARAN");
    ...
    strcpy(pat_old[4].doctor,"JHON C T");
    ...
    strcpy(pat_old[8].doctor,"SHIVANI");
    ...
    strcpy(pat_old[10].doctor,"YESHWANTH");
    ...
    strcpy(pat_old[11].doctor,"SHARUKH KHAN");
    ...
    strcpy(pat_old[12].doctor,"YESHWANTH");
    ...
    strcpy(pat_old[13].doctor,"SHARUKH KHAN");
    ...
    strcpy(pat_old[14].doctor,"SHIVANI");
    ...
    strcpy(pat_old[15].doctor,"SHIVANI");
    ...
    strcpy(pat_old[16].doctor,"YESHWANTH");
    ...
    strcpy(pat_old[18].doctor,"HARIHARAN");
    ...
    strcpy(pat_old[19].doctor,"JHON C T");
    ...
    strcpy(pat_old[20].doctor,"HARIHARN");
    ...
    strcpy(pat_old[22].doctor,"SHARUKH KHAN");
    ...
    strcpy(pat_old[23].doctor,"HARIHARAN");
    ...
    strcpy(pat_old[24].doctor,"SHIVANI");
    ...
    strcpy(pat_old[25].doctor,"SHARUKH KHAN");
    ...
    strcpy(pat_old[26].doctor,"JHON C T");
    ...
    strcpy(pat_old[27].doctor,"SHARUKH KHAN");
    ...
    strcpy(pat_old[29].doctor,"HARIHARAN");
...
void NPAT()
{
    ...
    if(strcmp(pat_new[count1].admittedin,"Cardiologist")==0)
        ...
        printf("\n            =>Doctor Appointed - yeshwanth\n");
    else if(strcmp(pat_new[count1].admittedin,"Neurologist")==0)
        printf("\n            =>Doctor Appointed - sharukh khan\n");
    else
    {
